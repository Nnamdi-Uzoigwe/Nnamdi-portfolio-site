...
export default function Navigation() {
    ...
    return (
        <div className="bg-[#454545] w-full lg:w-fit py-[16px] border-1 border-[#737373] fixed bottom-0 lg:sticky flex justify-center lg:justify-start gap-2 lg:gap-10 rounded-[12px] px-[24px]">
