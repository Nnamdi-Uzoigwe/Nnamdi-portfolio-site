...
export default function About() {
  const data = [
    ...
    },
    {
      ...
      description:
        "Developing intuitive mobile applications for both iOS and Android platforms.",
      icon: "/app.png",
    },
    {
      id: 3,
      ...
      description:
        "Building the server-side logic, databases, and infrastructure that power applications.",
      icon: "/db.png",
    },
    {
      id: 4,
      ...
      description:
        "Connecting different systems and services through custom APIs and third-party integrations.",
      icon: "/app.png",
    },
  ];
  return (
    <div className="mt-10 z-40">
      ...
      <div className="pb-10">
        <h3 className="text-lg lg:text-2xl font-semibold mb-6">
          Skills & Expertise
        </h3>
        <motion.div
          initial={{ opacity: 0, y: 60 }}
